...
export default function Login(props){
    ...
    const  onSubmit=async ()=>{
        checkPass();checkEmail();setErrorLogin(false);
        if(erroremail===''|| errorpassword===''){
            let req_data={email:email,password:sha256(password)}
            let payload={token:jwt.sign(req_data,API_SECRET_KEY)};
               ...
               <h2>User Login</h2>
                ...
                <div className="input-container">
                   <div className="input-field-container">
                        ...
                        type="email" placeholder="Email ID" name="email" value={email} onChange={(e)=>setEmail(e.target.value)} onBlur={checkEmail}/>
                    </div> 
                ...
                <div className="input-container">
                    <div className="input-field-container">
                        ...
                        value={password} onChange={(e)=>setPassword(e.target.value)} onBlur={checkPass}/>
                ...
                <div className="forgotnew">
                    ...
                    <Link href="#"><a>New User? Create an Account</a></Link>
                </div>
            </div>
        </div>
